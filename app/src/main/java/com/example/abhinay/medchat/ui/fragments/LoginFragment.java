...
import com.example.abhinay.medchat.core.login.LoginContract;
import com.example.abhinay.medchat.core.login.LoginInteractor;
import com.example.abhinay.medchat.ui.activities.RegisterActivity;
import com.example.abhinay.medchat.ui.activities.UserListingActivity;


public class LoginFragment extends Fragment implements View.OnClickListener, LoginContract.View {
    private LoginInteractor.LoginPresenter mLoginPresenter;
    ...
    private void init() {
        mLoginPresenter = new LoginInteractor.LoginPresenter(this);
